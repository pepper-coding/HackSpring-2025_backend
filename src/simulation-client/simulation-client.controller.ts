...
export class SimulationClientController {
  ...
  constructor(
    private readonly simulationClientService: SimulationClientService,
  ) {}
  ...
  @ApiBody({
    description:
      'Simulation configuration with store layout, time of day, and other parameters',
    type: SimulationRequestDto,
  })
  async runSimulation(
    @Body() simulationRequest: SimulationRequestDto,
